...
var Editor = function(options) {
    ...
    // set default template url if url not exist
    this.setDefaultTemplateUrlIfNotExist();
...
Editor.prototype = {
    ...
    setDefaultTemplateUrlIfNotExist: function() {
        if(typeof(this.url) == 'undefined' && typeof(this.html) == 'undefined') {
            this.url = this.root + 'templates/default/';
        }
    },
    ...
    loadingSetMessage: function (data) {
        $('.loading-page-overlay label').html(this.transformHtml(data));
    },
    ...
    // hide loading effect when done
        ...
        // load widgets from stack
        thisEditor.widgetsStack.forEach(function(item) {
            thisEditor.addContentWidget(item.widget, item.index, item.group);
        });

        // load widgets from WidgetManager
        thisEditor.loadWidgetsFromWidgetManager();

        // more less widgets
        thisEditor.moreLessWidgetsSetup();

        // flag when builder done loaded
        thisEditor.isInitialized = true;
    },

    loadWidgetsFromWidgetManager: function() {
        var thisEditor = this;
    ...
    setupIframe: function(callback) {
        ...
        // Fix do not drag element to iframe
        $("#builder_iframe").contents().find('body').append('<div builder-element="PageElement" style="padding-top:50px;padding-bottom:50px;"></div>');
        ...
        thisEditor.loadIframeJs(jss, function () {
            thisEditor.loadingSetMessage('{language.scripts_loaded}');
    ...
    initIframe: function() {
        ...
        thisEditor.iframe.on('load', function() {
            thisEditor.setupIframe(function() {
                thisEditor.loadingSetMessage('{language.finalizing}');
        ...
        if (!thisEditor.url) {            
            ...
            thisEditor.loadingSetMessage('{language.loading_template}');
    ...
    afterIframeLoaded: function() {
        ...
        $("#builder_iframe").contents().find("body").on('mouseover', '*', function(e) {
            ...
            while (element != null && !element.canHover() && obj.parents('[builder-element]').length) {
                obj = obj.parents('[builder-element]').first();
                element = thisEditor.elementFactory(obj);
            }
    ...
    loadWidgets: function() {
        ...
        if (thisEditor.formFields && thisEditor.formFields.length) {
            ...
            // Add submit button
            thisEditor.addWidget(new SubmitButtonWidget(), {
                index: 0,
                group: 'form'
            });
            // add form class
        ...
        if (this.strict) {
            ...
            thisEditor.addWidget(new TwoColumnsWidget());
            thisEditor.addWidget(new ThreeColumnsWidget());

            thisEditor.addWidget(new CenterLogoWidget());
            thisEditor.addWidget(new TextWidget());
            thisEditor.addWidget(new ImageWidget());
            thisEditor.addWidget(new IntroBlockWidget());
            
            
            thisEditor.addWidget(new OneColumnBlockWidget());
            thisEditor.addWidget(new TwoColumnsBlockWidget());
            thisEditor.addWidget(new ThreeColumnsBlockWidget());

            thisEditor.addWidget(new YoutubeWidget());

            thisEditor.addWidget(new SocialLinksBlockWidget());
            thisEditor.addWidget(new PricingTableWidget());
            thisEditor.addWidget(new DividerWidget());

            thisEditor.addWidget(new BoxedTextWidget());
            thisEditor.addWidget(new HeaderBlockWidget());
            thisEditor.addWidget(new HeroImageWidget());

            
            thisEditor.addWidget(new TwoArticlesBlockWidget());
            thisEditor.addWidget(new TwoArticlesRTLBlockWidget());
            thisEditor.addWidget(new FooterBlockWidget());
            
            
            
            thisEditor.addWidget(new ButtonWidget());
            thisEditor.addWidget(new Button2Widget());
            thisEditor.addWidget(new VideoWidget());
            thisEditor.addWidget(new TableWidget());
            thisEditor.addWidget(new Table4Widget());
            thisEditor.addWidget(new Table5Widget());            
            // thisEditor.addWidget(new ButtonWidget());
            // thisEditor.addWidget(new SocialWidget());
            // thisEditor.addWidget(new HtmlWidget());
            // thisEditor.addWidget(new ImageCaptionWidget());
            // thisEditor.addWidget(new FooterWidget());
            // thisEditor.addWidget(new HeaderWidget());            
            // thisEditor.addWidget(new ListImageWidget());
            // thisEditor.addWidget(new ProgressBarWidget());
            // thisEditor.addWidget(new ListGroupWidget());
            // thisEditor.addWidget(new PanelWidget());
            // thisEditor.addWidget(new ImageHeaderWidget());
            // thisEditor.addWidget(new JumbotronWidget());
            // thisEditor.addWidget(new MeterialWidget());
            // thisEditor.addWidget(new NavbarWidget());
            // thisEditor.addWidget(new PricingTableWidget());
            // thisEditor.addWidget(new ServicesListWidget());
            // thisEditor.addWidget(new ImageGridWidget());
            // thisEditor.addWidget(new UserProfileWidget());
            // thisEditor.addWidget(new DivContainerWidget());
            // thisEditor.addWidget(new ContainerWidget());
            // thisEditor.addWidget(new WellWidget());
            // thisEditor.addWidget(new MediaObjectWidget());
            // thisEditor.addWidget(new ParagraphWidget());
            // thisEditor.addWidget(new MarkedTextWidget());
            // thisEditor.addWidget(new DefinitionListWidget());
            // thisEditor.addWidget(new BlockqouteWidget());
            // thisEditor.addWidget(new UnorderedListWidget());
            // thisEditor.addWidget(new HeadingWidget());
            // thisEditor.addWidget(new LinkWidget());
            // thisEditor.addWidget(new ButtonGroupWidget());
            // thisEditor.addWidget(new ButtonToolbarWidget());
            // thisEditor.addWidget(new InputFieldWidget());
            // thisEditor.addWidget(new TextAreaWidget());
            // thisEditor.addWidget(new CheckboxWidget());
            // thisEditor.addWidget(new InputGroupWidget());
            // thisEditor.addWidget(new FormGroupWidget());
            // thisEditor.addWidget(new SelectWidget());
            // thisEditor.addWidget(new FormWidget());
        }
    ...
    moreLessWidgetsSetup: function() {
        $('.widgets-section').each(function() {
            var group = $(this);
            var widgets = group.find('.widget-item');
            var slideing = 18;

            widgets.removeClass('hide');
            widgets.slice(slideing).addClass('hide');

            group.find('a.link-show_more').on('click', function() {
                var widgets = group.find('.widget-item');
                widgets.slice(slideing).removeClass('hide');
                group.find('a.link-show_more').hide();
                group.find('a.link-hide_less').show();
            });

            group.find('a.link-hide_less').on('click', function() {
                var widgets = group.find('.widget-item');
                widgets.slice(slideing).addClass('hide');
                group.find('a.link-hide_less').hide();
                group.find('a.link-show_more').show();
            });
    ...
    addWidget: function(widget, options) {
        ...
        if (typeof(options.index) == 'undefined') {
            options.index = thisEditor.widgetsStack.length;
        }

        // if editor is initialized then just insert the widget
        if (thisEditor.isInitialized) {
            thisEditor.addContentWidget(widget, options.index, options.group);

        // else put widget to stack
        } else {
            thisEditor.widgetsStack.push({
                widget: widget,
                group: options.group,
                index: options.index,
            });
            ...
            // sort stack
            thisEditor.widgetsStack.sort((a, b) => {
    ...
    addContentWidget: function(widget, index, group) {
        ...
        if (group !== null) {
            if (!$('[widgets-group="'+group+'"]').length) {
                // add new group
                $('.widgets-sections').append(thisEditor.transformHtml(`
                    <div class="widgets-section widgets-other mb-4" widgets-group="`+group+`">
                        ...
                        <div class="load-show_more" style="display:flex;justify-content:center">
                            <a class="link-widget link-show_more" title="Show more widget" style="cursor: pointer; padding: 5px 20px; background: rgb(229, 229, 229); border-radius: 2px;">Show more...</a>
                            <a class="link-widget link-hide_less" title="Show less widget" style="cursor: pointer; padding: 5px 20px; background: rgb(229, 229, 229); border-radius: 2px; display: none;">Show less...</a>
                        </div>
                    </div>
                `));
            }
        ...
        var new_w = $(thisEditor.transformHtml(html));
        var posItem;
    ...
    addCustomWidget: function(element, item) {
        ...
        $(document).on('click', '.btn-add-custom-widget-'+w.id, function() {
            ...
            var new_w = thisEditor.addWidget(thisEditor.addingWidget);
    ...
    doExport: function() {
        ...
        $('#exportForm').remove();
        var form = $(`
            <form id="exportForm" style="display:none" action="`+thisEditor.export.url+`" method="POST" target="_blank">
                `+data+`
    ...
    loadEvents: function() {
        ...
        $(document).on('click', 'li.device-bg img.bg-image', function(e) {
            ...
            $('.content-background').addClass(mode);
        });
    ...
    handleSelect: function(callback) {
        var thisEditor = this;
    ...
    setControlsBarTitle: function(name) {
        $('.properties-pannel-title h4').html(name);
    },
    ...
    loadControls: function() {
        ...
        // set sidebar title
        this.setControlsBarTitle(this.selected.name());
